...
export async function seedDatabase() {
  ...
  const booksData = [
    { title: "Ježeva kućica", author: "Branko Ćopić", ageGroup: "R1", genre: "bajke_basne", readingDifficulty: "lako" as const, pageCount: 32, description: "Klasična priča o ježu koji gradi kućicu i uči o prijateljstvu i gostoprimstvu. Omiljeno djelo za najmlađe čitaoce.", timesRead: 50, weeklyPick: true },
    { title: "Priče o poslanicima", author: "Hajrudin Ahmetović", ageGroup: "R1", genre: "islam", readingDifficulty: "lako" as const, pageCount: 128, description: "Priče o životima Božijih poslanika ispričane na pristupačan način za djecu. Uči o lijepom ponašanju, hrabrosti i vjeri.", timesRead: 35 },
    { title: "Priče iz davnine", author: "Ivana Brlić-Mažuranić", ageGroup: "R1", genre: "bajke_basne", readingDifficulty: "lako" as const, pageCount: 158, description: "Zbirka čarobnih priča inspirisanih slavenskom mitologijom. Bajkoviti svijet vila, divova i čarobnih bića koji oduševljava generacije mladih čitalaca.", timesRead: 38 },
    { title: "Vlak u snijegu", author: "Mato Lovrak", ageGroup: "R1", genre: "avantura_fantasy", readingDifficulty: "lako" as const, pageCount: 112, description: "Uzbudljiva priča o grupi djece čiji vlak zapne u snijegu. Djeca pokazuju nevjerovatnu hrabrost i solidarnost dok čekaju pomoć.", timesRead: 30 },
    { title: "Družba Pere Kvržice", author: "Mato Lovrak", ageGroup: "R4", genre: "lektira", readingDifficulty: "srednje" as const, pageCount: 180, description: "Roman o grupi dječaka koji osnivaju družbu i zajednički rade na poboljšanju svog sela. Priča o prijateljstvu, solidarnosti i zajedništvu.", timesRead: 22 },
    { title: "Hajduk u Beogradu", author: "Ivan Cankar", ageGroup: "R4", genre: "avantura_fantasy", readingDifficulty: "srednje" as const, pageCount: 196, description: "Uzbudljiva avanturistička priča o mladiću koji se suočava s izazovima odrastanja i pustolovina u velikom gradu.", timesRead: 18 },
    { title: "Mali princ", author: "Antoine de Saint-Exupéry", ageGroup: "R4", genre: "lektira", readingDifficulty: "srednje" as const, pageCount: 96, description: "Poetična priča o malom princu koji putuje s planeta na planet i uči o životu, ljubavi i prijateljstvu.", timesRead: 45 },
    { title: "Hasanaginica", author: "Narodna balada", ageGroup: "R4", genre: "lektira", readingDifficulty: "srednje" as const, pageCount: 24, description: "Jedna od najpoznatijih južnoslavenskih balada o tragičnoj sudbini Hasanagine žene. Djelo univerzalne vrijednosti.", timesRead: 15 },
