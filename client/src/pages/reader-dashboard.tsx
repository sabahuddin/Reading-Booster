      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Card className="hover-elevate">
            <Link href="/citanje/biblioteka" data-testid="link-library-card">
              <CardHeader>
          ...
          <Card className="hover-elevate">
            <Link href="/citanje/rezultati" data-testid="link-results-card">
              <CardHeader>
                <div className="flex items-center gap-3">
            ...
            {isLoading ? (
              ...
              <div className="text-center py-8">
                ...
                <Button asChild className="mt-4" data-testid="link-start-reading">
                  <Link href="/citanje/biblioteka">Počni čitati</Link>
                </Button>
              </div>
            ) : (
              <Table>
